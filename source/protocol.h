...
#define	svc_spawnstaticsound	29	// [coord3] [short] samp [byte] vol [byte] aten
...
#define svc_hudtoast		45		// [string] power-up toast text
#define svc_pulse 			46
...
#define svc_roundcolor		54 		// [coord] red [coord] green [coord] blue
...
#define svc_hudconfig 		58		// [byte] index [string] config string
