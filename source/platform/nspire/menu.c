...
void M_Main_Draw (void)
{
	...
	Draw_Fill (16, (22 * (m_main_cursor+1)) - 4, 8 * strlen(main_menu_items[m_main_cursor]), 2, 254);
	Draw_Fill (16, (22 * (m_main_cursor+1)) + 10, 8 * strlen(main_menu_items[m_main_cursor]), 2, 254);
}
...
void M_Menu_Setup_f (void)
{
	...
	setup_top = setup_oldtop = 0;
	setup_bottom = setup_oldbottom = 0;
}
